...
class AuthorsController extends AppController
{
    ...
    public function index()
    {
        ...
        // $topAuthors = $this->Authors->getTopAuthorsLastWeek();
    ...
    public function articlesByAuthorId($authorId)
    {
        $this->request->allowMethod(['get']);
        $this->autoRender = false;

        $articles = $this->Authors->getArticlesByAuthorId($authorId);
    ...
    public function topAuthorsLastWeek()
    {
        ...
        echo json_encode($topAuthorsArray);
    }
}
